...
public class RoleController {
    ...
    public Result<List<Role>> list() {
        return Result.success(roleLogic.listRoles());
    }

    @GetMapping("/{id}")
    public Result<Role> getById(@PathVariable Long id) {
        return Result.success(roleLogic.getRoleById(id));
    }
